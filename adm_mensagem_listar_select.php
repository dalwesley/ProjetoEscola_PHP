...
$sql = "SELECT *, DATE_FORMAT(mural_data_cadastro, '%d/%m/%Y') as 'mural_data_cadastro' FROM mural where mural_mes='$mes_select' AND mural_dia='$dia_select'"; //Faz o select de todos os registros
					...
					<a href='adm_mensagem_cadastrar.php?m=$mes_select&&d=$dia_select','mural' title='cadastrar mensagem para o dia $dia_select do mês $mes_select' class='alert-link'>
						<table border='0' width='100%' cellspacing='0' cellpadding='3'  bordercolor='#FFF' height='0' style='border-collapse: collapse'> 
							<tr>
								...
								<td>
									<center>Exibindo <B><i>".$result."</i></B> resultado(s) para o dia $dia_select </center></i></strong>
								</td>
							</tr>
						</table>
					</a>
				...
				<div class='panel panel-default'>
					<div class='panel-heading'>
						<h3 class='panel-title'><center>
							Mês</B>/<B>$dia_select</B> Sem Mensagem cadastrada!
						</h3>
					</div>
