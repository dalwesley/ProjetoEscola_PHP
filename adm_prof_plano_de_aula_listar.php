...
include "conecta.php";
$id_select = $_GET['id']; //Recupera a variavel id para fazer o select
$sql = mysql_query("SELECT * from plano_de_aula where plano_prof_id=$id_select");
...
$plano_id						= $linha['disciplina_id'];
$plano_nome					= $linha['disciplina_nome'];
$plano_prof_nome				= $linha['disciplina_prof_nome'];
$plano_prof_id					= $linha['disciplina_prof_id'];
$plano_ano_civil				= $linha['disciplina_ano_civil'];
$plano_serie					= $linha['disciplina_serie'];
$plano_turma					= $linha['disciplina_turma'];
$plano_secretario				= $linha['disciplina_secretario'];
$plano_diretor					= $linha['disciplina_diretor'];
$plano_data					= $linha['disciplina_data'];
	
echo"<fieldset style='border-style: solid; border-width: 1px; background-color:#F0F0F0'><legend><B>Disciplina: $plano_nome</B></legend>
...
Diretor(a): <B>$linha[disciplina_diretor]</B>
		...
		<td align='center'><pre>
<B>Editar
<a href='adm_prof_disciplina_editar.php?id=$plano_prof_id&&opcao=$plano_id' style='text-decoration: none'><img src='img/edit.png' border='0' width='24' height='24' title='Editar Matrícula'></a></td>
		</td>
	</tr>
	<tr>
		<td align='center'><pre>
<B>Excluir
<a href='adm_prof_disciplina_excluir.php?id=$plano_prof_id&&opcao=$plano_id' style='text-decoration: none'><img src='img/delete.png' border='0' width='24' height='24' title='Excluir Matrícula'></a></td>
		</td>
	</tr>
	</table>
</pre>
...
<table border='1' width='100%' cellspacing='0' cellpadding='3'  bordercolor='#FFFFFF' height='0' style='border-collapse: collapse'> 
	...
	<tr>
		<td align='center'>
			<a href='adm_prof_disciplina_cadastrar.php?id=$plano_prof_id' style='text-decoration: none'>
...
<table border='1' width='100%' cellspacing='0' cellpadding='3'  bordercolor='#FFFFFF' height='0' style='border-collapse: collapse'> 
	<tr>
		...
		<br><i><strong>".$linha['prof_nome']."</i></strong> sem plano de aula cadastrado!<br><br>
		</td>
	</tr>
	<tr>
		<td align='center'>
			<b>Cadastrar<br>
			<a href='adm_prof_plano_de_aula_cadastrar.php?id=$prof_id' style='text-decoration: none'>
			<img src='img/new.png' border='0' width='24' height='24' title='Cadastrar'></a>
		</td>
	</tr>
</table>
