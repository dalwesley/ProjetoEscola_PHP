...
$usuario_endereço		= $row['usuario_endereço'];
...
<table border='1' width='100%' cellspacing='0' cellpadding='3'  bordercolor='#F0F0F0' height='0' style='border-collapse: collapse'> 
	<tr>
		...
		<td>
			<center>Editando <B><I>Dados  de usuário</B></I> para <i><strong>$usuario_nome - $usuario_id</center></i></strong>
		</td>
		<td>
...
<label>Endereço:	<input name='usuario_endereço' type='text' id='rua' size='59' value='$row[usuario_endereço]'/></label> Nº:<input name='usuario_numero' type='text' id='usuario_numero' size='2' maxlength='70' value='$row[usuario_numero]' />
...
<fieldset style='border-style: solid; border-width: 1px; background-color:#F0F0F0'>
<legend><font color='#0000FF'><B>Editar Usuário</B></font></legend><pre>
...
Nível:		<select name='usuario_nivel' id='usuario_nivel'>
...
<table border='1' width='100%' cellspacing='0' cellpadding='3'  bordercolor='#FFFFFF' height='0' style='border-collapse: collapse'> 
	<tr>
		<td align=center bgcolor=#FFFFFF><font color='#0000FF'>Tem certeza que deseja editar os <b>dados de usuário</b> do(a) <b>$usuario_nome</b>?</b></font><br></td>
		</td>
	</tr>	
	<tr>
		<td align='center'>
