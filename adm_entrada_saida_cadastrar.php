			...
			<div class='col-sm-12'>
				<div class='panel panel-default'>
					...
					<div class='panel-body'>
						...
						<div class='col-xs-12'>
							<textarea class='form-control' name=es_outros_motivos id=es_outros_motivos placeholder='Informações ou outros motivos referente a Entrada ou Saída.' rows='6' cols='80' wrap='hard'></textarea>
						</div>
					</div>
				</div>
			</div>
				...
				<div class='panel panel-default'>
					...
					<div class='panel-body'>
						<table border='1' width='100%' cellspacing='0' cellpadding='3'  bordercolor='#FFFFFF' height='0' style='border-collapse: collapse'> 
							<tr>
								<td align=center bgcolor=#FFFFFF>Tem certeza que deseja cadastrar a <b>entrada/saída</b> para <b>$aluno_nome</b>?</b></font><br></td>	
							</tr>
							<tr>
								<td align='center'>
