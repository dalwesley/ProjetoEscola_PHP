...
$sql = "SELECT *, DATE_FORMAT(mural_data_cadastro, '%d/%m/%Y') as 'mural_data_cadastro' FROM mural where mural_mes='$mes_select' ORDER BY mural_dia ASC"; //Faz o select de todos os registros
				...
				<div class='panel panel-default'>
					<div class='panel-heading'>
						<h3 class='panel-title'><center>
							Mês</B>/<B>$mes_select</B> Sem Mensagem cadastrada!
						</h3>
					</div>
					<div class='panel-body'><center>
						<b>Cadastrar<br>
						<a href='adm_mensagem_cadastrar.php?m=$mes_select' style='text-decoration: none'>
