...
echo"
<form id='cadastro' name='cadastro' method='post' action='adm_aluno_obs_cadastrar_motor.php'>
					...
					<a href='#' class='alert-link'>
						<table border='0' width='100%' height='0'> 
							...
							<td height='1' width='1'>
								...
								<td>
									<center>Cadastrando <B><i>Observação</i></B> para <i><strong> $aluno_nome - $aluno_ra </center></i></strong>
								</td>
								<td height='1' width='1'>
					...
					<div class='panel-body'>
						<div class='col-xs-3'>
							<div class='input-group input-group-sm'>
								...
								<input type='hidden' class='form-control' name='obs' value='Sim' size='3'>
								<input type='hidden' class='form-control' name='obs_aluno_nome' value='$linha[aluno_nome]' size='60'>
								<input type='hidden' class='form-control' name='obs_aluno_id' value='$linha[aluno_id]' size='3'>
						...
						<div class='col-xs-9'>
							<div class='input-group input-group-sm'>
								...
								<input type='text' name='obs_visual_qual' class='form-control' id='obs_visual_qual' size='40' maxlength='70' placeholder='Qual?' />
							</div>
						</div>
						<div class='col-xs-3'>
							<div class='input-group input-group-sm'>
						...
						<div class='col-xs-9'>
							<div class='input-group input-group-sm'>
								...
								<input type='text' name='obs_auditiva_qual' id='obs_auditiva_qual' class='form-control' size='40' maxlength='70' placeholder='Qual?' />
							</div>
						</div>
						<div class='col-xs-3'>
							<div class='input-group input-group-sm'>
						...
						<div class='col-xs-9'>
							<div class='input-group input-group-sm'>
								...
								<input type='text' name='obs_fisica_qual' id='obs_fisica_qual' class='form-control' size='40' maxlength='70' placeholder='Qual?' />
							</div>
						</div>
						<div class='col-xs-3'>
							<div class='input-group input-group-sm'>
						...
						<div class='col-xs-9'>
							<div class='input-group input-group-sm'>
								...
								<input type='text' name='obs_movimento_qual' id='obs_movimento_qual' class='form-control' size='40' maxlength='70' placeholder='Qual?' />
							</div>
						</div>
						<div class='col-xs-3'>
							<div class='input-group input-group-sm'>
						...
						<div class='col-xs-9'>
							<div class='input-group input-group-sm'>
								...
								<input type='text' name='obs_comportamento_qual' id='obs_comportamento_qual' class='form-control' size='40' maxlength='70' placeholder='Qual?' />
							</div>
						</div>
						<div class='col-xs-6'>
							<div class='input-group input-group-sm'>
						...
						<div class='col-sm-12'>
							<textarea class='form-control' rows='3' name=obs_mencionar_prob_import id=obs_mencionar_prob_import placeholder='Ex:Outras informações referente ao aluno'  wrap='hard'></textarea>
						</div><br>
					</div>
				</div>
			</div>
